...
const PrintBarcodePage = () => {
    const allProducts = [
        { id: 1, productName: 'Laptop', sku: 'LAP-001' },
        { id: 2, productName: 'T-shirt', sku: 'TSH-002' },
        // ... your product data
    ];
    ...
    const downloadBarcodePDF = async () => {
      if (selectedProduct) {
          ...
          const barcodeWidth = (pageWidth - 40) / 4; // Adjust for 4 barcodes per row
          const barcodeHeight = 20; // Reduced height
          ...
          for (let i = 0; i < printQuantity; i++) {
              ...
              JsBarcode(tempSvg, selectedProduct.sku, { height: 30, displayValue: true }); // Reduce SVG height
